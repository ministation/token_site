        ...
        <div class="post" data-post-id="${post.id}">
            <div class="post-header">
                ...
                <div class="post-author-info">
                    <div class="post-author-name">${post.author_discord_username || 'Неизвестный'}</div>
                    <div class="post-author-nick">@${post.author_nickname || 'unknown'}</div>
    ...
    if (commentsDiv.style.display === 'none') {
        try {
            ...
            comments.forEach(c => {
                html += `
                    <div class="comment">
                        <img src="${c.author_avatar || '/static/default_avatar.png'}" class="comment-avatar" alt="" onerror="this.src='/static/default_avatar.png'">
                        <div class="comment-content">
                            <div class="comment-author">${c.author_nickname || 'Аноним'}</div>
...
async function addComment(postId) {
    ...
    try {
        ...
        input.value = '';
        toggleComments(postId); // обновить
