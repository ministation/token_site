...
DONATION_TIERS: dict[int, dict[str, Any]] = {
    1: {
        ...
        "perks": [
            ...
            "Зелёный цвет в ahelp / OOC",
            "1 гарантированный вор или агент в день",
    ...
    2: {
        ...
        "perks": [
            "+30 монет в месяц",
            "Особая роль в Discord",
            "Серебряный цвет в ahelp / OOC",
            "Повышенный шанс крупных антагов",
            "1 гарантированный ниндзя / дракон / абдуктор / нулевой / ревенант в день",
            "Пропуск на заполненный сервер",
        ],
    },
    3: {
        ...
        "perks": [
            "+40 монет в месяц",
            "Особая роль в Discord",
            "Жёлтый цвет в ahelp / OOC",
            "1 гарантированный нуки / глава ревы / культист / дьявол / абдуктор в день",
            "Пропуск на заполненный сервер",
    ...
    4: {
        ...
        "perks": [
            "+60 монет в месяц",
            "Особая роль в Discord",
            "Фиолетовый цвет в ahelp / OOC",
            "1 гарантированный крупный антаг в день",
            "Пропуск на заполненный сервер",
            "Все привилегии предыдущих уровней",
        ],
    },
    5: {
        ...
        "perks": [
            ...
            "Оранжевый цвет в ahelp / OOC",
            "Допуск к собраниям совета",
            "Приоритет предложений к разработке",
            "Все привилегии предыдущих уровней",
        ],
    },
}
...
PAYMENT_METHODS = [
    {"id": 2, "label": "СБП / QR", "hint": "Быстрый перевод через СБП"},
    {"id": 10, "label": "Карта МИР", "hint": "Банковская карта РФ"},
    {"id": 12, "label": "Международная карта", "hint": "Visa / Mastercard"},
]
